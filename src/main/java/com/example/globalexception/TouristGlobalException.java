...
public class TouristGlobalException {
	...
	@ExceptionHandler
	public ResponseEntity<ErrorDetails> handletouristException(TouristNotFoundException txf){
		
		
		ErrorDetails error = new ErrorDetails(txf.getMessage(), LocalDateTime.now());
